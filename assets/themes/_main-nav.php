...
<div class="leftmenu">
  <ul class="nav nav-tabs nav-stacked">
    ...
    <!--MENU manajemen-->
    <?php
	if($_SESSION['login_hash']=="manajemen")
	{
	?>
    <li class="dropdown"><a href="#"><span class="icon-th-list"></span> Data Master</a>
      <ul>
        <li><a href="?cat=manajemen&page=barang">Barang</a></li>
       
      </ul>
    </li>        
    <li class="dropdown"><a href="#"><span class="icon-pencil"></span> Transaksi</a>
      <ul>
        <li><a href="?cat=manajemen&page=entry">Barang Masuk</a></li>
        <li><a href="?cat=manajemen&page=sell">Barang Keluar</a></li>       
      </ul>
    </li>
    <li class="dropdown"><a href="#"><span class="icon-pencil"></span> Laporan</a>
      <ul>
        <li><a href="?cat=manajemen&page=monthreporting">Laporan Masuk dan Keluar</a></li>       
      </ul>
    </li>
    <?php
