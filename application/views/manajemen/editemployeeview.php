...
echo form_open('manajemen/employee/update?uid='.$id.'',$att);
?>
<div class="control-group">
<label class="control-label" for="inputEmail">Nama</label>
<div class="controls">
<input type="text" id="inputEmail" name="nama" value="<?=$nama;?>" placeholder="Nama karyawan" data-validation="length" data-validation-length="min3">
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputEmail">Alamat</label>
<div class="controls">
<input type="text" id="inputEmail" name="alamat" value="<?=$alamat;?>"placeholder="Alamat Karyawan" data-validation="length" data-validation-length="min3">
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputEmail">Tanggal Lahir</label>
<div class="controls">
<input type="text"  id="datepicker2" name="tanggal" value="<?=$tanggal;?>" placeholder="Tanggal" title="Klik dan pilih Tanggal">
</div>
</div>
<div class="control-group">
<label class="control-label" for="inputEmail">Nomor</label>
<div class="controls">
<input type="text" id="inputEmail" name="nomor" value="<?=$nomor;?>" placeholder="ID Karyawan" data-validation="length" data-validation-length="min3" readonly="readonly">
</div>
</div>
<div class="control-group">
